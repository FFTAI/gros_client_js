...
import { Human, ArmAction, Motor, HandAction, BodyAction } from "./lib/robot/human";
...
const car = new Car();
car.set_mode(CarMod.MOD_ACTION)
    .then(result => {
        console.log(result);
    })
    .catch(error => {
...
module.exports = { Human, Car, CarMod, get_robot_type, ArmAction, RobotBase, Motor, HandAction, BodyAction }
// Exporting elements using ES6 syntax
export { Human, Car, CarMod, Camera, System, get_robot_type, ArmAction, RobotBase, Motor, HandAction, BodyAction };
